  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        const sparkleOpacity = 0.12 + 0.12 * Math.sin(time * 0.02 + i);
    ...
    >
      ...
      <div className="relative z-10 mb-10 animate-fade-up" style={{ opacity: 0, animationDelay: "0.1s" }}>
        ...
        <img
          ...
          className="w-48 h-48 sm:w-60 sm:h-60 object-contain drop-shadow-[0_0_40px_rgba(0,174,239,0.3)]"
          fetchPriority="high"
        />
      </div>

      {/* Progress */}
      <div className="w-56 z-10 animate-fade-up" style={{ animationDelay: "0.3s", opacity: 0 }}>
        <div className="h-1 bg-white/10 rounded-full overflow-hidden backdrop-blur-sm">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 16px rgba(0,174,239,0.5)",
            }}
          />
        </div>
        <p className="text-center text-white/25 text-xs mt-4 tracking-[0.2em] font-light uppercase">
